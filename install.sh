...
unzip scanner.zip $(PWD)/packages/sonar-scanner-msbuild-4.2.0.1214-netcoreapp2.0
chmod +x $(PWD)/packages/sonar-scanner-msbuild-4.2.0.1214-netcoreapp2.0/sonar-scanner-3.1.0.1141/bin/sonar-scanner

export OPENCOVER=$(PWD)/packages/sonar-scanner-msbuild-4.2.0.1214-netcoreapp2.0/SonarCloud.MSBuild.dll
export SONARCLOUD=$(PWD)/packages/OpenCover.4.6.519/tools/OpenCover.Console.exe
