namespace Build.Tests.TestSet16
{
    ...
    public class WebServiceDataRepository : IPersonRepository
    {
        ...
        public WebServiceDataRepository(
            [Injection("Build.Tests.TestSet16.ServiceDataRepository", 2021)]IPersonRepository repositoryA, 
            [Injection("Build.Tests.TestSet16.ServiceDataRepository", 2022)]IPersonRepository repositoryB)
        {
