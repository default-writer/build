...
namespace Build
{
    class TypeParser : ITypeParser
    {
        public IRuntimeType Find(string typeId, string[] args, IEnumerable<IRuntimeType> types)
        {
            ...
            if (runtimeType == null)
            {
                ...
                while (runtimeType == null && enumerator.MoveNext())
                {
                    ...
                    runtimeType = Find(parameterType.ToString(), args, parameterType.RuntimeParameters);
                }
            }
            return runtimeType;
        }
        ...
        {
            if (runtimeType.RuntimeTypeId != name)
                return false;
            ...
            for (int i = 0; i < match.Count; i++)
            {
                ...
                if (parameterType.RuntimeTypeId != argumentType)
