...
:dotnet_build
  ...
  echo/ ========== NuGet ==========
  echo/ > build.log
  for %%v in (net451 net452 net46 net461 net462 net47 net471 net472 netstandard1.5 netstandard1.6 netstandard2.0 netcoreapp1.0 netcoreapp1.1 netcoreapp2.0 netcoreapp2.1 netcoreapp3.0) do (
