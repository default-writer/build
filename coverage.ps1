...
& dotnet test --configuration Release --no-build Build.Tests /p:CollectCoverage=true /p:CoverletOutputFormat=opencover /p:Include="[build.*]*" /p:Exclude="[xunit*]*,[build.abstractions.*]*" -v:n
